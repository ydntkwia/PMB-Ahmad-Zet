		...
		<div class="container-fluid">
			<div class="row heading-bg">
				...
				<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo base_url() ?>user-mahasiswa">User Mahasiswa</a></li>
					</ol>
				</div>
				<!-- /Breadcrumb -->
			</div>
			...
			if ($connected){
				...
				<div class="alert red-7-bg alert-dismissible show" role="alert">
					<strong>Alert!</strong> Koneksi bermasalah, Anda tidak bisa mengirim pesan!
			...
			if ($this->session->flashdata('reset_pass') != '' ) 
			{ 
				?>
				<div class="alert green-7-bg alert-dismissible show" role="alert">
					<strong>Alert!</strong> <?php echo $this->session->userdata('reset_pass'); ?>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
								...
								<table id="datable_1" class="table table-hover display  pb-30">
									...
									<tbody>
										...
										foreach ($mahasiswa as $key) {
											...
											$pesan = "https://web.whatsapp.com/send?phone=$no_telp&text=*Hallo%20$str_nama*&source=&data=";
											?>
											<tr>
												<td><?php echo $no ?></td>
												...
												<td>
													...
													if ($connected){
														?>
														<a class=" btn blue-5-bg" onclick="window.open('<?php echo $pesan ?>');" href="javascript:void(0)"><i class="fa fa-comments"></i></a>
														<?php
													}else{
													?>
												...
												?>
												<a class=" btn btn-info" style="color: white" data-toggle="modal" data-target="#delete<?php echo $key->id_user?>"><i class="fa fa-recycle"></i></a>
												<!-- modal delete -->
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															<div class="modal-body pt-35-px pb-35-px">
																<center>
																	<span class="f-20-px">Reset Password?</span>
																</center>
															</div>
															<div class="modal-footer">
																<center>
																	<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
																	<button type="button" class="btn btn-info" onclick="window.location.href='<?php echo base_url() ?>Admin/reset_pass/<?php echo $key->id_user?>'">Reset</button>
																</center>
															</div>
														</div>
													</div>
