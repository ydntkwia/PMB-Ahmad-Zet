				...
				<form class="login100-form validate-form">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<a href="<?php echo base_url() ?>force-login" class="btn btn-info form-login"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;Tetap Login</a>
						</div>	
					</div>

					<div class="wrap-login100-form-btn m-t-20">
						<div class="login100-form-bgbtn"></div>
						<a href="<?php echo base_url() ?>force-logout" class="btn btn-danger"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Batal Login</a>
					</div>	
