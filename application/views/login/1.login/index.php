			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				...
				<form class="login100-form validate-form" action="<?php echo base_url('login');?>" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						...
						<input required="" class="input100" onkeypress="input_number(event)" type="text" autocomplete="off" name="nis" >
					...
					<div style="margin-bottom: 20px;margin-top: -20px">
						<span>Lupa password? hubungi <a href="https://web.whatsapp.com/send?phone=6281312119466&text=*Hallo%20Admin*&source=&data=" target="_blank">Admin</a></span>
					</div>
